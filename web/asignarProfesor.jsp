...
<BODY background="img/background2.jpg">
		...
		<FORM ACTION="controlador" METHOD="POST">
			<tr>
				...
				<th><input id="idProfesor" type="text" name="idProfesor"
					...
					value="<%out.print(((Usuario) request.getSession().getAttribute("profesorAsignar"))
					.getId());%>" /></th>
			...
			<tr>
				<TD><input type="submit" value="Asignar"> <input
					type="hidden" name="opc" value="asignarImparticion"></TD>
			</tr>
		</FORM>
		<tr>
		</tr>
	...
	%>
	<div align="center">
		<a href="gestionProfesores.jsp">Atrás</a>
	</div>
</BODY>
</HTML>
<%
